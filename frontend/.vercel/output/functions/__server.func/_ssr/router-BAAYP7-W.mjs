...
//#region node_modules/.nitro/vite/services/ssr/assets/router-BAAYP7-W.js
var import_react = /* @__PURE__ */ __toESM(require_react());
var import_jsx_runtime = require_jsx_runtime();
var styles_default = "/assets/styles-JwQVfMrU.css";
...
var Route$2 = createRootRouteWithContext()({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Swipe through live RSS stories one card at a time, grouped by section."
			},
			{
				name: "author",
				content: "Chronicle Editorial"
			},
			{
				property: "og:title",
				content: "Chronicle — Swipe the Day's News"
			},
			{
...
var $$splitComponentImporter = () => import("./routes-YC8a9h1y.mjs");
var Route = createFileRoute("/")({
	...
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Swipe through the latest RSS stories one card at a time, grouped by section."
			},
			{
				property: "og:title",
				content: "Chronicle — Swipe the Day's News"
